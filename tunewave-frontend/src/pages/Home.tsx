  ...
  return (
    <div className="p-4 space-y-8 pb-24 max-w-4xl mx-auto">
      ...
      <section>
        ...
        {followed.length === 0 ? (
          <p className="text-sm text-text-secondary card">Follow artists to see their latest music here.</p>
        ) : (
          <div className="flex space-x-4 overflow-x-auto pb-4 scrollbar-hide">
            {followed.map((song) => (
              <div key={song._id} className="min-w-[140px] space-y-2 card">
                <div className="relative w-[120px] h-[120px] rounded-2xl shadow-lg overflow-hidden">
