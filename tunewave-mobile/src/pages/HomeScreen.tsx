...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 24, fontWeight: '900', color: '#FFF', padding: 16, marginBottom: 16 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#FFF', paddingHorizontal: 16, marginBottom: 8 },
  emptyText: { fontSize: 14, color: '#666', paddingHorizontal: 16, marginBottom: 16 },
  horizontalScroll: { paddingHorizontal: 16, marginBottom: 24 },
  ...
  songTitle: { fontSize: 14, fontWeight: '500', color: '#FFF' },
  artistName: { fontSize: 12, color: '#AAA' },
});
