...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  const storeSession = useCallback(async (newToken: string, authenticatedUser: AuthUser) => {
    await AsyncStorage.setItem(authTokenStorageKey, newToken);
    setToken(newToken);
  ...
  const refreshUser = useCallback(async () => {
    const storedToken = await AsyncStorage.getItem(authTokenStorageKey);
